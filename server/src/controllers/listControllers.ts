 ...
 * Controllers
 */
export const addList = async (req: AddListReq, res: ListRes): Promise<ListRes> => {
  const list = req.body;
...
export const updateList = async (req: UpdateListReq, res: ListRes): Promise<ListRes> => {
  const list = req.body;
...
export const deleteList = async (req: DeleteListReq, res: ListRes): Promise<ListRes> => {
